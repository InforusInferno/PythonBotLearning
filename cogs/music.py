# could not get it to work probably because of YouTube anti-bot measures and I do not have the ability to
# experiment with it on self-hosting through a raspberry etc. if you can fix it, go right ahead, and tell me what you did to do so
# im running it on a railway server and the most accepted explanation i have right now is that it's being blocked
# feel free to reach out regarding a possible fix

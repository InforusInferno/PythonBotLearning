...
# Study Timer
`/pomodoro start [time]` - in minutes
`/pomodoro group [time]` - starts a group timer, with a button to join
...
`/kick [member]` - get out
`/ban [member]` - get out but forever
...
Clone repo
Install reqs
Set up env and put token there (dont push it to github)
Run :D

u can deploy on railway or whatever you want pretty much

# INVITE LINK
https://discord.com/oauth2/authorize?client_id=1495096883327139971&permissions=277025467398&integration_type=0&scope=bot

# LAST UPDATE: 4/25/2026 2:35 PM GMT+3
